  ...
  return (
    <Section align="left" heightClass="h-[200vh]" isFirst={true} topClass="top-[35%]">
      <div className="max-w-xl">
        ...
        <button className="mt-8 px-10 py-4 bg-[#B88E52] hover:bg-[#8C6B3D] text-white font-medium tracking-wide rounded-full transition-all duration-300 shadow-[0_8px_30px_rgb(184,142,82,0.3)] hover:shadow-[0_8px_30px_rgb(184,142,82,0.5)] transform hover:-translate-y-1">
          Explore Collection
        </button>
      </div>
    </Section>
